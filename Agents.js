...
async function main() {
  ...
  const messages = [
    ...
    },
    {
      role: 'user',
      content:
        'Hey, create a folder todo_app and create a simple todo aplication using html, css and javaScript',
        // 'In the current directly, read the changes via git and push the changes to github with good commit message'
        // 'Hey , Tell me how many public_repos of anurag357 has on github.'
    },
  ];
